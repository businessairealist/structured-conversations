---
name: flow-efficiency-calculator
render_family: form
description: Calculate work time, wait time, lead time, and total flow efficiency for a mapped process. Use when you need a diagnostic efficiency baseline from value-stream timing data.
---

# Flow Efficiency Calculator

Calculate work time, wait time, lead time, and overall flow efficiency from step timing data.
