...
name: okri-builder
render_family: form
description: Draft or update an OKRI record that connects one objective to measurable key results and the initiatives expected to move them. Use when you need a structured OKRI statement or record rather than only a visual map.
---

# OKRI Builder

Draft an OKRI record as a canonical form artifact rooted in evidence.
...
- One objective.
## Structure The OKRI Record

Keep the record concrete enough to guide execution.

At minimum capture:

- objective statement
- measurable key results
- initiatives linked to each key result
- rationale, evidence, or upstream artifacts
- owner, horizon, or review cadence when known
- assumptions, dependencies, and open questions

If the initiative layer is missing, add it explicitly rather than leaving the OKR disconnected from execution.
