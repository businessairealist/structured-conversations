...
render_family: board
description: Build or update a classic customer journey map from stage, touchpoint, and experience evidence. Use when you need a poster-style journey map with a left guide panel, stage columns, and rows for activities, needs, experience, and notes or ideas.
---

# Customer Journey Map Builder

Build a customer journey map from evidence rooted in evidence.
...
- Stage, touchpoint, or journey evidence.
## Structure The Map

Organize the artifact around one clearly named persona and a stage-based journey.
...
- needs by stage
- experience by stage
- notes or ideas by stage

Prefer evidence-backed wording. Keep missing evidence as open questions instead of guessing.
