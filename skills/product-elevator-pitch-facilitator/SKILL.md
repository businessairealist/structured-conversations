---
name: product-elevator-pitch-facilitator
render_family: matrix
description: "Create a workshop-ready product elevator pitch using the standard seven-line pitch syntax with audience, problem, value, alternative, and differentiator prompts. Use when you need to facilitate collaborative pitch drafting that feeds comparison, persona adaptation, or epic hypothesis work."
---

# Product Elevator Pitch Facilitator

Create a workshop-ready product elevator pitch artifact using the standard seven-line pitch syntax.
...
- the user wants to facilitate collaborative pitch drafting
- product positioning needs audience, problem, value, alternative, and differentiator prompts
- the pitch will feed comparison, persona adaptation, or epic hypothesis work
