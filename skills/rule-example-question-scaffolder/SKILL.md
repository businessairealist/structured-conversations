---
name: rule-example-question-scaffolder
render_family: board
description: Build or update an example-mapping board . Use when you need to organize a user story into rules, examples, and unresolved questions in a rendered canvas similar to the Example Mapping board.
---

# Rule Example Question Scaffolder

Build an example-mapping board rooted in the feature-specification runtime.
