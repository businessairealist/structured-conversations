---
name: story-split-decision-tree-guide
render_family: tree
description: "Guide teams through a decision tree to determine whether to simplify, split, or spike an oversized story. Use when the best splitting method is unclear and a quick diagnostic is needed before committing to an approach."
---

# Story Split Decision Tree Guide

Guide teams through a decision tree to simplify, split, or spike a story.
...
- the team is unsure whether to simplify, split, or spike first
- the story is too large but the best split method is unclear
- the next step should be chosen with a small diagnostic guide
