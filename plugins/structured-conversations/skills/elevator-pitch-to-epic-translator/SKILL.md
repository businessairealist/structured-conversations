---
name: elevator-pitch-to-epic-translator
render_family: form
description: "Translate an elevator pitch into an epic hypothesis scaffold with outcomes, key results, and constraints. Use when you need to connect a product value narrative to measurable planning inputs for epics, OKRs, or indicators."
---

# Elevator Pitch To Epic Translator

Translate an elevator pitch into an epic hypothesis scaffold with outcomes, key results, and constraints.
...
- a product pitch should become planning input
- the team needs to connect value narrative to measurable outcomes
- downstream epic, OKR, or indicator skills need a structured source artifact
