---
name: spidr-slice-generator
render_family: plan
description: "Apply SPIDR dimensions (Spike, Path, Interface, Data, Rule) to split a large story into smaller, testable pieces. Use when you need to identify the clearest split axis and produce the first clean slice before planning the rest."
---

# SPIDR Slice Generator

Apply SPIDR dimensions to split a large story into smaller, testable pieces.
...
- rules, data, interfaces, paths, or spikes are the clearest split axis
- the story is too broad for a single implementation step
- the team wants the first clean slice before planning the rest
