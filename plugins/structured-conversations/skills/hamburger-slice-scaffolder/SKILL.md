---
name: hamburger-slice-scaffolder
render_family: plan
description: "Apply the hamburger method to split a story into quality-layered vertical slices that ship in progressively richer layers. Use when you need to preserve customer value while adding quality over time instead of delivering everything at once."
---
...
- a story should ship in thin, progressively richer layers
- the team wants to preserve customer value while adding quality over time
- the next step is to convert one big story into layered slices
