---
name: outcome-driven-epic-writer
render_family: form
description: Build or update an epic hypothesis statement . Use when you need to write an epic with a clear name, owner, description, business outcomes, product OKR, leading indicators, and nonfunctional constraints in a rendered statement format similar to the Writing Epics board.
---

# Outcome Driven Epic Writer

Build a decision-ready epic hypothesis statement rooted in the feature-specification runtime.
