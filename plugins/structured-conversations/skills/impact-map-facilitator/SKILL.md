---
name: impact-map-facilitator
render_family: board
description: "Facilitate an impact-mapping workshop from goal through actors, impacts, and deliverables. Use when you need a workshop artifact that surfaces missing evidence and branching options while the goal and actors are still being discussed."
---

# Impact Map Facilitator

Facilitate an impact-mapping workshop from goal through actors, impacts, and deliverables.
...
- the team needs a workshop artifact rather than a finished impact map
- the goal, actors, and impacts are still being discussed
- the map should surface missing evidence and branching options
