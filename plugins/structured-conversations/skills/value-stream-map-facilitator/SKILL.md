---
name: value-stream-map-facilitator
render_family: flow
description: Facilitate a value-stream mapping session from start and end points through future-state discussion. Use when you need a workshop-ready value stream artifact rather than a finalized process map.
---

# Value Stream Map Facilitator

Create a workshop-ready value stream map with current-state timing, issue prompts, and future-state questions.


Read these references when needed:

- [value-stream-map-facilitator.md](././references/mapping/value-stream-map-facilitator.md)
