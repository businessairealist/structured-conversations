...
render_family: tree
description: "Expand a target outcome into opportunities, solutions, and experiments in a structured tree. Use when you need to compare multiple solution branches and keep experiments visible before committing to a build."
---
...
- the team wants to compare multiple solution branches without overcommitting
- an outcome needs structured decomposition before planning
- experiments should stay visible alongside the candidate solutions
