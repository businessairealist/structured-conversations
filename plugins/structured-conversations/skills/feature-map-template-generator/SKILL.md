---
name: feature-map-template-generator
render_family: board
description: "Generate a reusable feature-map template with standard discovery lanes already prepared. Use when you need a clean workshop board for repeated feature discovery sessions before a specific feature is chosen."
---

# Feature Map Template Generator

Generate a reusable feature-map template with the standard discovery lanes already prepared.
...
- a team wants a reusable workshop board before a specific feature is chosen
- facilitators need a clean starting point for repeated discovery sessions
- the user wants a template rather than a filled artifact
