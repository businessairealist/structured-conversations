---
name: severity-priority-classifier
render_family: matrix
description: Classify or update a defect’s severity and priority from defect reports, reproduction evidence, customer impact, and operational context. Use when you need a consistent severity/priority recommendation with rationale, tradeoffs, and uncertainty called out explicitly.
---

# Severity Priority Classifier

Classify a defect into a clear severity and priority recommendation as a canonical quality artifact.
...
- A defect report, reproduction scaffold, or equivalent failure evidence.
## Structure The Classification

Make the recommendation auditable, not just declarative.

At minimum capture:

- proposed severity
- proposed priority
- rationale tied to user or business impact
- affected surface area and frequency
- workaround availability
- release or operational urgency
- evidence used and confidence level
- escalation triggers or follow-up questions

If the team rubric is missing, state the rubric assumptions used. If severity and priority diverge, explain why.
