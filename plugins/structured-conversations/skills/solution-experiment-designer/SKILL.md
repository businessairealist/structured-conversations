---
name: solution-experiment-designer
render_family: form
description: "Design testable experiments for candidate solutions so teams can validate the best branch before build-out. Use when you need validation criteria, signals, and risks visible for a solution before the team commits to full implementation."
---

# Solution Experiment Designer

Design testable experiments for candidate solutions so teams can validate the best branch before build-out.
...
- candidate solutions need validation criteria
- the next step is a small experiment instead of a full build
- signals and risks should be visible before the team commits
