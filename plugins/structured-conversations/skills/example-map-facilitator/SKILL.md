---
name: example-map-facilitator
render_family: board
description: "Create a workshop-ready example map around a story, its rules, examples, and unresolved questions. Use when you need a live-session artifact where rules, examples, and open questions are captured together rather than in side notes."
---

# Example Map Facilitator

Create a workshop-ready example map around a story, its rules, examples, and unresolved questions.
...
- the user wants to run example mapping live with the team
- rules exist but examples are incomplete
- questions need to be captured as part of the artifact, not just in side notes

## Inputs

- story text
- optional rules, examples, and questions
