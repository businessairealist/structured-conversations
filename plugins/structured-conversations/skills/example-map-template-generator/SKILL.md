---
name: example-map-template-generator
render_family: board
description: "Generate a reusable example-map template for repeated story refinement and discovery sessions. Use when you need a consistent starting-point board for rules, examples, and questions before a specific story is chosen."
---

# Example Map Template Generator

Generate a reusable example-map template for repeated story refinement and discovery sessions.
...
- a facilitator wants a ready-made board for future workshops
- the user wants a template instead of a story-specific artifact
- teams need a consistent starting point for rules, examples, and questions
