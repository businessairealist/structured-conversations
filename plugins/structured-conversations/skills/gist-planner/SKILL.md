...
name: gist-planner
render_family: plan
description: "Organize a goal into ideas, steps, and tasks so execution can start without losing the outcome thread. Use when you need a lightweight execution plan that turns a vague goal into concrete delivery work without a heavyweight roadmap."
---
...
- a vague goal needs a lightweight execution plan
- the user wants ideas and tasks without a heavyweight roadmap
- the next step is to turn a goal into concrete delivery work
