---
name: journey-friction-analyzer
render_family: board
description: "Analyze a completed customer journey map to identify the highest-friction stages, strongest problem signals, and best improvement candidates. Use when you need a friction diagnosis and ranked improvement opportunities from an existing journey map."
---

# Journey Friction Analyzer

Analyze a completed customer journey map and write a reusable friction-analysis artifact.
...
- ranked friction points by stage
- strongest repeated signals or keywords
- candidate improvement areas drawn from the journey map
- assumptions and open questions about confidence gaps

Prefer evidence-backed wording. Keep weakly supported judgments explicit as heuristics.
