---
name: impact-to-story-translator
render_family: plan
description: "Turn impact-map branches into deliverable-ready stories, hypotheses, or backlog items that preserve the intended behavioral change. Use when you need to convert an impact map into delivery work without losing the outcome thread."
---

# Impact To Story Translator

Turn impact-map branches into deliverable-ready stories, hypotheses, or next-step backlog items.
...
- an impact map needs to become delivery work
- the team wants stories that preserve the intended behavioral change
- the next step is splitting the work into backlog-ready items
