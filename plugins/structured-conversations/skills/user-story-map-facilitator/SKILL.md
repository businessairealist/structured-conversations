---
name: user-story-map-facilitator
render_family: board
description: Run a story-mapping workshop from user goal through activities, tasks, stories, and release slices. Use when you need a workshop-ready story-map artifact rather than a final backlog commitment.
---

# User Story Map Facilitator

Create a workshop-ready classic user story map with backbone activities, story prompts, and starter release slices.


Use this skill when the team needs a facilitation artifact for story mapping rather than a finalized backlog map.
...
2. Draft backbone activities.
3. Prompt the team for tasks and stories under each activity.
4. Use release slices as facilitation prompts, not commitments.
