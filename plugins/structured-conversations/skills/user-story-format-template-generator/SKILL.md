---
name: user-story-format-template-generator
render_family: matrix
description: "Generate reusable blank templates that pair each story format with syntax prompts and INVEST checkboxes. Use when you need a standard starting point that helps teams pick the right format before writing."
---

# User Story Format Template Generator

Generate reusable blank templates that pair each story format with syntax prompts and INVEST checkboxes.
...
- a team needs a standard format template for drafting stories
- syntax prompts should appear alongside the format options
- the output should help teams pick the right format before writing
