---
name: defect-context-capture-scaffolder
render_family: form
description: "Create a defect context artifact with environment, system, version, observed behavior, and triage prompts. Use when you need better diagnostic inputs before writing a defect report, reproducing a failure, or prioritizing a bug."
---

# Defect Context Capture Scaffolder

Create a defect context artifact with environment, system, version, observed behavior, and triage prompts.
...
- the user has an observed failure but not enough diagnostic context
- a defect report or reproduction path needs better inputs
- environment/version evidence should be captured before prioritization
