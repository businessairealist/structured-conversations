---
name: story-hierarchy-organizer
render_family: tree
description: "Structure backlog content into a user-story-map hierarchy of activities, tasks, and stories. Use when you need to turn a flat backlog into a readable map that feeds story mapping or release planning."
---
...
- the team needs to organize a backlog into a readable hierarchy
- activities and tasks need to become a map instead of a flat list
- the output should feed story mapping or release planning
