---
name: process-waste-classifier
render_family: matrix
description: Classify mapped waste patterns so improvement conversations can focus on concrete categories. Use when you need a structured waste diagnosis from process notes or a value stream map.
---

# Process Waste Classifier

Classify process waste by step so improvement work can target concrete categories instead of vague friction.
